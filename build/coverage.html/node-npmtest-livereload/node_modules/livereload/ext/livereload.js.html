...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-livereload/node_modules/livereload/ext/livereload.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-livereload">npmtest-livereload (v0.0.3)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-livereload/node_modules/livereload/ext/livereload.js</span></h1>
    <h2>
        
        Statements: <span class="metric">4.03% <small>(29 / 720)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">1.67% <small>(5 / 300)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">4.64% <small>(7 / 151)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">2.58% <small>(18 / 697)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-livereload/node_modules/livereload/ext/</a> &#187; livereload.js</div>
</div>
<div class="body">
...
1183
1184
1185</td><td class="line-coverage"><span class="cline-any cline-yes">4</span>
...
<span class="cstat-no" title="statement not covered" >  var Connector, PROTOCOL_6, PROTOCOL_7, Parser, Version, _ref;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  _ref = require('./protocol'), Parser = _ref.Parser, PROTOCOL_6 = _ref.PROTOCOL_6, PROTOCOL_7 = _ref.PROTOCOL_7;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  Version = '2.2.2';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  exports.Connector = Connector = (<span class="fstat-no" title="function not covered" >function() {</span></span>
...
<span class="cstat-no" title="statement not covered" >      this._uri = "ws" + (this.options.https ? "s" : "") + "://" + this.options.host + ":" + this.options.port + "/livereload";</span>
...
<span class="cstat-no" title="statement not covered" >      this.protocolParser = new Parser({</span>
        connected: (<span class="fstat-no" title="function not covered" >function(_this) {</span>
<span class="cstat-no" title="statement not covered" >          return <span class="fstat-no" title="function not covered" >function(protocol) {</span></span>
...
<span class="cstat-no" title="statement not covered" >            return _this.handlers.connected(protocol);</span>
        ...
        error: (<span class="fstat-no" title="function not covered" >function(_this) {</span>
...
<span class="cstat-no" title="statement not covered" >            return _this._closeOnError();</span>
        ...
        message: (<span class="fstat-no" title="function not covered" >function(_this) {</span>
...
<span class="cstat-no" title="statement not covered" >      this._handshakeTimeout = new Timer((<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
...
<span class="cstat-no" title="statement not covered" >      this._reconnectTimer = new Timer((<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >function() {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Connector.prototype._isSocketConnected = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      return this.socket &amp;&amp; this.socket.readyState === this.WebSocket.OPEN;</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    Connector.prototype.connect = <span class="fstat-no" title="function not covered" >function() {</span></span>
...
<span class="cstat-no" title="statement not covered" >      this.socket.onopen = (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >function(e) {</span></span>
<span class="cstat-no" title="statement not covered" >          return _this._onopen(e);</span>
        };
      })(this);
<span class="cstat-no" title="statement not covered" >      this.socket.onclose = (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >function(e) {</span></span>
<span class="cstat-no" title="statement not covered" >          return _this._onclose(e);</span>
        };
      })(this);
<span class="cstat-no" title="statement not covered" >      this.socket.onmessage = (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >function(e) {</span></span>
<span class="cstat-no" title="statement not covered" >          return _this._onmessage(e);</span>
        };
      })(this);
<span class="cstat-no" title="statement not covered" >      return this.socket.onerror = (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >function(e) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Connector.prototype.disconnect = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      this._connectionDesired = false;</span>
<span class="cstat-no" title="statement not covered" >      this._reconnectTimer.stop();</span>
<span class="cstat-no" title="statement not covered" >      if (!this._isSocketConnected()) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Connector.prototype._scheduleReconnection = <span class="fstat-no" title="function not covered" >function() {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Connector.prototype.sendCommand = <span class="fstat-no" title="function not covered" >function(command) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Connector.prototype._sendCommand = <span class="fstat-no" title="function not covered" >function(command) {</span></span>
<span class="cstat-no" title="statement not covered" >      return this.socket.send(JSON.stringify(command));</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    Connector.prototype._closeOnError = <span class="fstat-no" title="function not covered" >function() {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Connector.prototype._onopen = <span class="fstat-no" title="function not covered" >function(e) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Connector.prototype._onclose = <span class="fstat-no" title="function not covered" >function(e) {</span></span>
<span class="cstat-no" title="statement not covered" >      this.protocol = 0;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Connector.prototype._onerror = <span class="fstat-no" title="function not covered" >function(e) {</span>};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    Connector.prototype._onmessage = <span class="fstat-no" title="function not covered" >function(e) {</span></span>
...
<span class="cstat-no" title="statement not covered" >(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  var LessPlugin;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  module.exports = LessPlugin = (<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    LessPlugin.identifier = 'less';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    LessPlugin.version = '1.0';</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    LessPlugin.prototype.reload = <span class="fstat-no" title="function not covered" >function(path, options) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    LessPlugin.prototype.reloadLess = <span class="fstat-no" title="function not covered" >function(path) {</span></span>
...
<span class="cstat-no" title="statement not covered" >          if (link.href &amp;&amp; link.rel.match(/^stylesheet\/less$/i) || (link.rel.match(/stylesheet/i) &amp;&amp; link.type.match(/^text\/(x-)?less$/i))) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    LessPlugin.prototype.analyze = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      return {</span>
        disable: !!(this.window.less &amp;&amp; this.window.less.refresh)
      };
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    return LessPlugin;</span>
&nbsp;
  })();
&nbsp;
}).call(this);
...
<span class="cstat-no" title="statement not covered" >(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  var Connector, LiveReload, Options, Reloader, Timer,</span>
    __hasProp = {}.hasOwnProperty;
&nbsp;
<span class="cstat-no" title="statement not covered" >  Connector = require('./connector').Connector;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  Timer = require('./timer').Timer;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  Options = require('./options').Options;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  Reloader = require('./reloader').Reloader;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  exports.LiveReload = LiveReload = (<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="fstat-no" title="function not covered" >    function LiveReload(window) {</span>
<span class="cstat-no" title="statement not covered" >      var k, v, _ref;</span>
<span class="cstat-no" title="statement not covered" >      this.window = window;</span>
...
<span class="cstat-no" title="statement not covered" >      this.console = this.window.console &amp;&amp; this.window.console.log &amp;&amp; this.window.console.error ? this.window.location.href.match(/LR-verbose/) ? this.window.console : {</span>
...
<span class="cstat-no" title="statement not covered" >        this.console.error("LiveReload disabled because the browser does not seem to support web sockets");</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      if ('LiveReloadOptions' in window) {</span>
<span class="cstat-no" title="statement not covered" >        this.options = new Options();</span>
<span class="cstat-no" title="statement not covered" >        _ref = window['LiveReloadOptions'];</span>
...
<span class="cstat-no" title="statement not covered" >          this.options.set(k, v);</span>
        }
      } else {
<span class="cstat-no" title="statement not covered" >        this.options = Options.extract(this.window.document);</span>
<span class="cstat-no" title="statement not covered" >        if (!this.options) {</span>
<span class="cstat-no" title="statement not covered" >          this.console.error("LiveReload disabled because it could not find its own &lt;SCRIPT&gt; tag");</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
      }
...
<span class="cstat-no" title="statement not covered" >      this.connector = new Connector(this.options, this.WebSocket, Timer, {</span>
        connecting: (<span class="fstat-no" title="function not covered" >function(_this) {</span>
<span class="cstat-no" title="statement not covered" >          return <span class="fstat-no" title="function not covered" >function() {</span>};</span>
        })(this),
        socketConnected: (<span class="fstat-no" title="function not covered" >function(_this) {</span>
<span class="cstat-no" title="statement not covered" >          return <span class="fstat-no" title="function not covered" >function() {</span>};</span>
        })(this),
        connected: (<span class="fstat-no" title="function not covered" >function(_this) {</span>
<span class="cstat-no" title="statement not covered" >          return <span class="fstat-no" title="function not covered" >function(protocol) {</span></span>
...
<span class="cstat-no" title="statement not covered" >                return console.log("LiveReload internal error: " + e.message);</span>
        ...
        disconnected: (<span class="fstat-no" title="function not covered" >function(_this) {</span>
<span class="cstat-no" title="statement not covered" >          return <span class="fstat-no" title="function not covered" >function(reason, nextDelay) {</span></span>
<span class="cstat-no" title="statement not covered" >            var _base;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    LiveReload.prototype.on = <span class="fstat-no" title="function not covered" >function(eventName, handler) {</span></span>
<span class="cstat-no" title="statement not covered" >      return this.listeners[eventName] = handler;</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    LiveReload.prototype.log = <span class="fstat-no" title="function not covered" >function(message) {</span></span>
<span class="cstat-no" title="statement not covered" >      return this.console.log("" + message);</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    LiveReload.prototype.performReload = <span class="fstat-no" title="function not covered" >function(message) {</span></span>
<span class="cstat-no" title="statement not covered" >      var _ref, _ref1;</span>
<span class="cstat-no" title="statement not covered" >      this.log("LiveReload received reload request: " + (JSON.stringify(message, null, 2)));</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    LiveReload.prototype.performAlert = <span class="fstat-no" title="function not covered" >function(message) {</span></span>
<span class="cstat-no" title="statement not covered" >      return alert(message.message);</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    LiveReload.prototype.shutDown = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      var _base;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    LiveReload.prototype.hasPlugin = <span class="fstat-no" title="function not covered" >function(identifier) {</span></span>
<span class="cstat-no" title="statement not covered" >      return !!this.pluginIdentifiers[identifier];</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    LiveReload.prototype.addPlugin = <span class="fstat-no" title="function not covered" >function(pluginClass) {</span></span>
<span class="cstat-no" title="statement not covered" >      var plugin;</span>
<span class="cstat-no" title="statement not covered" >      if (!this.initialized) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      if (this.hasPlugin(pluginClass.identifier)) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
...
<span class="cstat-no" title="statement not covered" >      plugin = new pluginClass(this.window, {</span>
        ...
        Timer: Timer,
        generateCacheBustUrl: (<span class="fstat-no" title="function not covered" >function(_this) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    LiveReload.prototype.analyze = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      var plugin, pluginData, pluginsData, _i, _len, _ref;</span>
<span class="cstat-no" title="statement not covered" >      if (!this.initialized) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      if (!(this.connector.protocol &gt;= 7)) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return LiveReload;</span>
&nbsp;
  })();
&nbsp;
}).call(this);
&nbsp;
},{"./connector":1,"./options":5,"./reloader":7,"./timer":9}],5:[<span class="fstat-no" title="function not covered" >function(require,module,exports){</span>
<span class="cstat-no" title="statement not covered" >(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  var Options;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  exports.Options = Options = (<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="fstat-no" title="function not covered" >    function Options() {</span>
<span class="cstat-no" title="statement not covered" >      this.https = false;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Options.prototype.set = <span class="fstat-no" title="function not covered" >function(name, value) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  Options.extract = <span class="fstat-no" title="function not covered" >function(document) {</span></span>
<span class="cstat-no" title="statement not covered" >    var element, keyAndValue, m, mm, options, pair, src, _i, _j, _len, _len1, _ref, _ref1;</span>
...
<span class="cstat-no" title="statement not covered" >        options.https = src.indexOf("https") === 0;</span>
...
<span class="cstat-no" title="statement not covered" >          _ref1 = m[2].split('&amp;');</span>
<span class="cstat-no" title="statement not covered" >          for (_j = 0, _len1 = _ref1.length; _j &lt; _len1; _j++) {</span>
<span class="cstat-no" title="statement not covered" >            pair = _ref1[_j];</span>
...
&nbsp;
},{}],6:[<span class="fstat-no" title="function not covered" >function(require,module,exports){</span>
<span class="cstat-no" title="statement not covered" >(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  var PROTOCOL_6, PROTOCOL_7, Parser, ProtocolError,</span>
    __indexOf = [].indexOf || <span class="fstat-no" title="function not covered" >function(item) {</span> <span class="cstat-no" title="statement not covered" >for (var i = 0, l = this.length; i &lt; l; i++) { <span class="cstat-no" title="statement not covered" >if (i in this &amp;&amp; this[i] === item) <span class="cstat-no" title="statement not covered" >return i; </span></span>} <span class="cstat-no" title="statement not covered" ></span>return -1; </span>};
&nbsp;
<span class="cstat-no" title="statement not covered" >  exports.PROTOCOL_6 = PROTOCOL_6 = 'http://livereload.com/protocols/official-6';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  exports.PROTOCOL_7 = PROTOCOL_7 = 'http://livereload.com/protocols/official-7';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  exports.ProtocolError = ProtocolError = (<span class="fstat-no" title="function not covered" >function() {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  exports.Parser = Parser = (<span class="fstat-no" title="function not covered" >function() {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Parser.prototype.reset = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      return this.protocol = null;</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    Parser.prototype.process = <span class="fstat-no" title="function not covered" >function(data) {</span></span>
<span class="cstat-no" title="statement not covered" >      var command, e, message, options, _ref;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Parser.prototype._parseMessage = <span class="fstat-no" title="function not covered" >function(data, validCommands) {</span></span>
<span class="cstat-no" title="statement not covered" >      var e, message, _ref;</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        message = JSON.parse(data);</span>
      } catch (_error) {
<span class="cstat-no" title="statement not covered" >        e = _error;</span>
...
&nbsp;
},{}],7:[<span class="fstat-no" title="function not covered" >function(require,module,exports){</span>
<span class="cstat-no" title="statement not covered" >(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  var IMAGE_STYLES, Reloader, numberOfMatchingSegments, pathFromUrl, pathsMatch, pickBestMatch, splitUrl;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  splitUrl = <span class="fstat-no" title="function not covered" >function(url) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  pathFromUrl = <span class="fstat-no" title="function not covered" >function(url) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  pickBestMatch = <span class="fstat-no" title="function not covered" >function(path, objects, pathFunc) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  numberOfMatchingSegments = <span class="fstat-no" title="function not covered" >function(path1, path2) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  pathsMatch = <span class="fstat-no" title="function not covered" >function(path1, path2) {</span></span>
<span class="cstat-no" title="statement not covered" >    return numberOfMatchingSegments(path1, path2) &gt; 0;</span>
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  IMAGE_STYLES = [</span>
    {
      selector: 'background',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  exports.Reloader = Reloader = (<span class="fstat-no" title="function not covered" >function() {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.addPlugin = <span class="fstat-no" title="function not covered" >function(plugin) {</span></span>
<span class="cstat-no" title="statement not covered" >      return this.plugins.push(plugin);</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.analyze = <span class="fstat-no" title="function not covered" >function(callback) {</span></span>
<span class="cstat-no" title="statement not covered" >      return results;</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.reload = <span class="fstat-no" title="function not covered" >function(path, options) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        if (path.match(/\.css$/i)) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.reloadPage = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      return this.window.document.location.reload();</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.reloadImages = <span class="fstat-no" title="function not covered" >function(path) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.reloadStylesheetImages = <span class="fstat-no" title="function not covered" >function(styleSheet, path, expando) {</span></span>
<span class="cstat-no" title="statement not covered" >      var e, rule, rules, styleNames, _i, _j, _len, _len1;</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.reloadStyleImages = <span class="fstat-no" title="function not covered" >function(style, styleNames, path, expando) {</span></span>
...
<span class="cstat-no" title="statement not covered" >          newValue = value.replace(/\burl\s*\(([^)]*)\)/, (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >            return <span class="fstat-no" title="function not covered" >function(match, src) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.reloadStylesheet = <span class="fstat-no" title="function not covered" >function(path) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        for (_i = 0, _len = _ref.length; _i &lt; _len; _i++) {</span>
<span class="cstat-no" title="statement not covered" >          link = _ref[_i];</span>
<span class="cstat-no" title="statement not covered" >          if (link.rel.match(/^stylesheet$/i) &amp;&amp; !link.__LiveReload_pendingRemoval) {</span>
<span class="cstat-no" title="statement not covered" >            _results.push(link);</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        return _results;</span>
...
<span class="cstat-no" title="statement not covered" >      match = pickBestMatch(path, links.concat(imported), (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.collectImportedStylesheets = <span class="fstat-no" title="function not covered" >function(link, styleSheet, result) {</span></span>
<span class="cstat-no" title="statement not covered" >      var e, index, rule, rules, _i, _len;</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        rules = styleSheet != null ? styleSheet.cssRules : void 0;</span>
      } catch (_error) {
<span class="cstat-no" title="statement not covered" >        e = _error;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.waitUntilCssLoads = <span class="fstat-no" title="function not covered" >function(clone, func) {</span></span>
...
<span class="cstat-no" title="statement not covered" >      executeCallback = (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >function() {</span></span>
...
<span class="cstat-no" title="statement not covered" >      clone.onload = (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >          _this.console.log("LiveReload: the new stylesheet has finished loading");</span>
...
<span class="cstat-no" title="statement not covered" >        (poll = (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >          return <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >            if (clone.sheet) {</span>
<span class="cstat-no" title="statement not covered" >              _this.console.log("LiveReload is polling until the new CSS finishes loading...");</span>
<span class="cstat-no" title="statement not covered" >              return executeCallback();</span>
            } else {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.linkHref = <span class="fstat-no" title="function not covered" >function(link) {</span></span>
<span class="cstat-no" title="statement not covered" >      return link.href || link.getAttribute('data-href');</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.reattachStylesheetLink = <span class="fstat-no" title="function not covered" >function(link) {</span></span>
...
<span class="cstat-no" title="statement not covered" >      return this.waitUntilCssLoads(clone, (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >function() {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.reattachImportedRule = <span class="fstat-no" title="function not covered" >function(_arg) {</span></span>
...
<span class="cstat-no" title="statement not covered" >      return this.Timer.start(this.importCacheWaitPeriod, (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >function() {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.generateUniqueString = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      return 'livereload=' + Date.now();</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    Reloader.prototype.generateCacheBustUrl = <span class="fstat-no" title="function not covered" >function(url, expando) {</span></span>
<span class="cstat-no" title="statement not covered" >      var hash, oldParams, originalUrl, params, _ref;</span>
...
<span class="cstat-no" title="statement not covered" >          originalUrl = url;</span>
...
<span class="cstat-no" title="statement not covered" >          this.console.log("LiveReload is overriding source URL " + originalUrl + " with " + url);</span>
        }
      }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return Reloader;</span>
&nbsp;
  })();
&nbsp;
}).call(this);
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  LiveReload.addPlugin(require('./less'));</span>
&nbsp;
...
&nbsp;
},{"./customevents":2,"./less":3,"./livereload":4}],9:[<span class="fstat-no" title="function not covered" >function(require,module,exports){</span>
<span class="cstat-no" title="statement not covered" >(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >  var Timer;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  exports.Timer = Timer = (<span class="fstat-no" title="function not covered" >function() {</span></span>
...
<span class="cstat-no" title="statement not covered" >      this._handler = (<span class="fstat-no" title="function not covered" >function(_this) {</span></span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >          _this.running = false;</span>
<span class="cstat-no" title="statement not covered" >          _this.id = null;</span>
<span class="cstat-no" title="statement not covered" >          return _this.func();</span>
        };
      })(this);
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    Timer.prototype.start = <span class="fstat-no" title="function not covered" >function(timeout) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    Timer.prototype.stop = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      if (this.running) {</span>
<span class="cstat-no" title="statement not covered" >        clearTimeout(this.id);</span>
<span class="cstat-no" title="statement not covered" >        this.running = false;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  Timer.start = <span class="fstat-no" title="function not covered" >function(timeout, func) {</span></span>
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Wed Apr 19 2017 04:56:29 GMT+0000 (UTC)</div>
</div>
</body>
</html>
